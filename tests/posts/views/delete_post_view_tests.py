...
class DeletePostViewTests(BaseTestCase):
    ...
    def test_delete_post_view__when_user_is_auth_and_user_is_author_of_post__expect_to_show_correct_results(self):
    ...
    def test_delete_post_view__when_user_is_auth_and_user_is_superuser__expect_to_show_correct_results(self):
        user = self.user
